...
private void Awake()
    ...
    protected void SetBoidArray(BoidData[] m_boidArray, int numberOfElements)
    {
        ...
        for (int i=0; i < numberOfElements; i++)
        {
            ...
            //  the z is forward direction of the boid on the tangent plane, and the y axis is the up direction,
            //  which is perpendicular to the tangent plane;
            // The up y direction of the boid is negative to the  normal of the 2D circle mesh
            ...
            // and the world UP vector  Vector3.up(0,1,0), and points the  forward direction of the boid. 
