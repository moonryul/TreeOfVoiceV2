...
// Added by Moon Jung to increase the serial buffer sizes

#define SERIAL_RX_BUFFER_SIZE 256  // defined by Moon Jung
#define SERIAL_TX_BUFFER_SIZE 256  // defined by Moon Jung
